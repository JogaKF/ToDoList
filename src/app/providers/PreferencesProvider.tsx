...
const translations = {
  pl: {
    ...
    settings_activity_log: 'Dziennik dzialan',
    settings_activity_log_hint: 'Przegladaj i eksportuj lokalna historie zmian z kontekstem zadan oraz list.',
    settings_open_activity_log: 'Otworz dziennik',
    settings_sync_diagnostics: 'Diagnostyka sync',
    settings_sync_diagnostics_hint: 'Podejrzyj clientId, znaczniki czasu i lokalna kolejke zmian przed podlaczeniem backendu.',
    settings_open_sync_diagnostics: 'Otworz diagnostyke',
    sync_diag_eyebrow: 'Local sync lab',
    sync_diag_title: 'Diagnostyka sync',
    sync_diag_intro: 'Podglad fundamentu sync bez backendu. Tu sprawdzisz, czy lokalna queue zbiera zmiany tak, jak powinna.',
    sync_diag_refresh: 'Odswiez',
    sync_diag_refresh_hint: 'Na tym etapie diagnostyka tylko czyta lokalna baze. Czyszczenie bledow dodamy pozniej.',
    sync_diag_status_section: 'Stan klienta',
    sync_diag_status_hint: 'Te wartosci beda potrzebne przy push/pull i Last Write Wins.',
    sync_diag_client_id: 'Client ID',
    sync_diag_last_pulled: 'Last pulled',
    sync_diag_last_pushed: 'Last pushed',
    sync_diag_never: 'Nigdy',
    sync_diag_pending: 'Pending',
    sync_diag_failed: 'Failed',
    sync_diag_pushed: 'Pushed',
    sync_diag_queue_section: 'Ostatnie wpisy queue',
    sync_diag_queue_hint: 'Najnowsze lokalne wpisy z sync_queue, razem ze statusem, proba i skrotem payloadu.',
    sync_diag_loading_title: 'Laduje diagnostyke',
    sync_diag_loading_hint: 'Czytam metadata sync i ostatnie wpisy lokalnej kolejki.',
    sync_diag_empty_title: 'Queue jest pusta',
    sync_diag_empty_hint: 'Gdy zmienisz listy, zadania albo ustawienia, wpisy sync pojawia sie tutaj.',
    sync_diag_attempts: 'Proby',
    sync_diag_updated_at: 'Aktualizacja',
    activity_log_eyebrow: 'Local audit trail',
    activity_log_title: 'Dziennik dzialan',
    activity_log_intro: 'Chronologiczny zapis lokalnych zmian. Pomaga sprawdzic, co wydarzylo sie offline i ulatwia diagnostyke przed syncem.',
    activity_log_export_title: 'Eksport dziennika',
    activity_log_export_hint: 'JSON jest najlepszy do backupu i analizy, CSV do arkuszy kalkulacyjnych.',
    activity_log_export_json: 'Eksportuj JSON',
    activity_log_export_csv: 'Eksportuj CSV',
    activity_log_export_status: 'Status eksportu',
    activity_log_export_shared: 'Dziennik gotowy do udostepnienia',
    activity_log_export_saved: 'Dziennik zapisany lokalnie',
    activity_log_export_error: 'Nie udalo sie wyeksportowac dziennika',
    activity_log_filters: 'Filtry',
    activity_log_search_placeholder: 'Szukaj po opisie, tasku albo liscie',
    activity_log_all_actions: 'Wszystkie akcje',
    activity_log_summary: 'Podsumowanie',
    activity_log_summary_entries: 'Wpisy',
    activity_log_summary_actions: 'Typy akcji',
    activity_log_loading: 'Laduje dziennik',
    activity_log_loading_hint: 'Czytam lokalna historie zmian i lacze ja z zadaniami oraz listami.',
    activity_log_empty: 'Brak wpisow w dzienniku',
    activity_log_empty_hint: 'Gdy zaczniesz tworzyc, edytowac i usuwac zadania, wpisy pojawia sie tutaj.',
    activity_log_entries: 'Wpisy audytu',
  ...
  en: {
    ...
    settings_activity_log_hint: 'Review and export local change history with task and list context.',
    settings_open_activity_log: 'Open log',
    settings_sync_diagnostics: 'Sync diagnostics',
    settings_sync_diagnostics_hint: 'Inspect clientId, timestamps and the local change queue before connecting the backend.',
    settings_open_sync_diagnostics: 'Open diagnostics',
    sync_diag_eyebrow: 'Local sync lab',
    sync_diag_title: 'Sync diagnostics',
    sync_diag_intro: 'A backend-free view of the sync foundation. Use it to verify that the local queue captures changes correctly.',
    sync_diag_refresh: 'Refresh',
    sync_diag_refresh_hint: 'For now diagnostics only reads local storage. Error cleanup will come later.',
    sync_diag_status_section: 'Client state',
    sync_diag_status_hint: 'These values will be used by push/pull and Last Write Wins.',
    sync_diag_client_id: 'Client ID',
    sync_diag_last_pulled: 'Last pulled',
    sync_diag_last_pushed: 'Last pushed',
    sync_diag_never: 'Never',
    sync_diag_pending: 'Pending',
    sync_diag_failed: 'Failed',
    sync_diag_pushed: 'Pushed',
    sync_diag_queue_section: 'Recent queue entries',
    sync_diag_queue_hint: 'Newest local sync_queue entries with status, attempts and a payload summary.',
    sync_diag_loading_title: 'Loading diagnostics',
    sync_diag_loading_hint: 'Reading sync metadata and recent local queue entries.',
    sync_diag_empty_title: 'Queue is empty',
    sync_diag_empty_hint: 'When you edit lists, tasks or settings, sync entries will appear here.',
    sync_diag_attempts: 'Attempts',
    sync_diag_updated_at: 'Updated',
    activity_log_eyebrow: 'Local audit trail',
    activity_log_title: 'Activity log',
    activity_log_intro: 'A chronological local change history. Useful for understanding offline work and preparing for sync diagnostics.',
    activity_log_export_title: 'Export activity log',
    activity_log_export_hint: 'JSON is best for backup and analysis, CSV works well in spreadsheets.',
    activity_log_export_json: 'Export JSON',
    activity_log_export_csv: 'Export CSV',
    activity_log_export_status: 'Export status',
    activity_log_export_shared: 'Activity log ready to share',
    activity_log_export_saved: 'Activity log saved locally',
    activity_log_export_error: 'Could not export activity log',
    activity_log_filters: 'Filters',
    activity_log_search_placeholder: 'Search description, task or list',
    activity_log_all_actions: 'All actions',
    activity_log_summary: 'Summary',
    activity_log_summary_entries: 'Entries',
    activity_log_summary_actions: 'Action types',
    activity_log_loading: 'Loading activity log',
    activity_log_loading_hint: 'Reading local history and joining it with tasks and lists.',
    activity_log_empty: 'No log entries yet',
    activity_log_empty_hint: 'When you create, edit and delete tasks, entries will appear here.',
    activity_log_entries: 'Audit entries',
    dictionary_eyebrow: 'Shopping dictionary',
